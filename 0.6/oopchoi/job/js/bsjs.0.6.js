...
( function( W, N ){
    ...
    detectWindow = function( W, detect ){
        ...
        for( i in t0 = {
            ...
            file:W['FileReader'] ? 1 : 0, message:W['postMessage'] ? 1 : 0, db:W['openDatabase'] ? 1 : 0, socket:W['WebSocket'] ? 1 : 0,
            xhr2:W['XMLHttpRequest'] && 'responseType' in new XMLHttpRequest ? 1 : 0,
            geo:( navigator['geolocation'] ) ? 1 : 0, history:( 'pushState' in history ) ? 1 : 0, offline:W['applicationCache'] ? 1 : 0,
            local:(function(){
        ...
        (function(trim){
            ...
            fn( 'trim', (function(trim){
                ...
                (function(){
                    ...
                    if( window['DOMParser'] ) type = 1, parser = new DOMParser, xml = function( end, v ){return xml0( parser.parseFromString( filter(v), "text/xml" ), end );};
                    else type = 0, parser = (function(){
        ...
        var DOM = function(){
                ...
                bs.obj( 'KEY', (function(){
                    ...
                    fn( 'css', (function(trim){
                        var r = /^[-]?[0-9.]+$/, s = bs.Style(), c = bs.Css('.BSCSS000').style,
                            css = function(v){return c.cssText = '', s.S( c, v, 0 ), c.cssText;},
                    ...
                    bs.cls( 'Dom', function( fn, clsfn, bs ){
                        ...
                        clsfn.data = domData = (function(){
                            ...
                            clsfn.dom = dom = (function( query, html ){
                                var n = {length:0}, dom = function( sel, doc ){
                                    return typeof sel == 'string' ? sel.charAt(0) == '<' ? html(sel) : query(sel, doc) :
                            ...
                            fn.NEW = function(key, doc){
                                var t0 = dom( key, doc ), i = this.length = t0.length;
